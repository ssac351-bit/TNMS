...
import { Smartphone, X, CheckCircle2, Download, Share2, MoreVertical, PlusSquare, ExternalLink } from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl max-w-md w-full overflow-hidden shadow-2xl border border-slate-200 animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        ...
        <div className="bg-gradient-to-r from-[#0a4635] to-[#125844] text-white p-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-white/10 border border-white/20 flex items-center justify-center overflow-hidden">
              <img src="/pwa-192x192.png" alt="App Logo" className="w-10 h-10 object-contain rounded-xl" onError={(e) => { (e.target as HTMLElement).style.display = 'none'; }} />
        ...
        <div className="p-5 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="p-4 bg-emerald-50 rounded-2xl border border-emerald-300 text-center">
            <p className="text-xs text-emerald-950 font-bold mb-3">
              নিচের বাটনে চাপ দিলে সরাসরি অ্যান্ড্রয়েড ফোনে অ্যাপ হিসেবে ইনস্টল করার পপ-আপ আসবে:
            </p>
            <button
              onClick={() => {
                if (onNativeInstall) onNativeInstall();
              }}
              className="w-full bg-[#0a4635] hover:bg-[#125844] text-white font-black py-3 px-4 rounded-xl flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95 cursor-pointer text-sm"
            >
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200">
            <div className="flex items-center gap-2 font-black text-slate-800 text-xs sm:text-sm mb-3">
              ...
              <span>ক্রোম ব্রাউজার মেনু থেকে ইনস্টল করতে:</span>
            </div>
            <ol className="space-y-2.5 text-xs text-slate-600 font-medium">
              <li className="flex items-start gap-2">
                ...
                <span>উপরে ডানে <strong>৩টি ডট (⋮)</strong> মেনু বাটনে চাপুন।</span>
              </li>
              <li className="flex items-start gap-2">
                <Download size={16} className="text-emerald-600 shrink-0 mt-0.5" />
                <span>মেনু থেকে <strong>"Install app" (অ্যাপ ইনস্টল করুন)</strong> চাপুন।</span>
              </li>
            </ol>
          </div>
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200">
            <div className="flex items-center gap-2 font-black text-slate-800 text-xs sm:text-sm mb-3">
              ...
              <span>আইফোন (iOS Safari) এর জন্য:</span>
            </div>
            <ol className="space-y-2.5 text-xs text-slate-600 font-medium">
              <li className="flex items-start gap-2">
                <Share2 size={16} className="text-blue-600 shrink-0 mt-0.5" />
                <span>সাফারির নিচে থাকা <strong>Share (শেয়ার)</strong> বাটনে চাপুন &gt; <strong>"Add to Home Screen"</strong> চাপুন।</span>
              </li>
            </ol>
          </div>
